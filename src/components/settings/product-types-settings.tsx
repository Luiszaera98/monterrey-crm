...
import { addProductType, removeProductType } from '@/lib/actions/settingsActions';
...
export function ProductTypesSettings({ initialTypes }: ProductTypesSettingsProps) {
    ...
    const handleAdd = () => {
        ...
        startTransition(async () => {
            const result = await addProductType(newType);
            if (result.success) {
